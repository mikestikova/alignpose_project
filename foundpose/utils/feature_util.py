...
from foundpose.utils import logging, misc, geometry
...
def get_image_visual_features(
    ...
    feature_map_hwc = feature_map_chw.permute(1, 2, 0).reshape(
        feature_map_chw.shape[1] * feature_map_chw.shape[2], feature_map_chw.shape
    )
...
def get_visual_features_registered_in_3d(
    ...
    feature_map_chw = feature_map_chw.detach()
    feature_map_hwc = feature_map_chw.permute(1, 2, 0).reshape(
        feature_map_chw.shape[1] * feature_map_chw.shape[2], feature_map_chw.shape[0]
    )
