...
from foundpose.utils.misc import tensor_to_array, array_to_tensor
...
def vis_pointcloud_error(
    ...
    vertices_in_c = geometry.transform_3d_points_numpy(trans_m2c, object_repre.vertices)
...
def vis_pca_feature_map_projected(
    ...
    vis_pca_components = min(feature_map_hwc_np.shape[2], 3)
...
def vis_pca_feature_map(
    ...
    map_width = feature_map_hwc_np.shape[1]
    map_height = feature_map_hwc_np.shape[0]
    query_pca_transform = pca_projector.transform(
